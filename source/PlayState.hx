...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		*/
		...
		if (SONG.song.toLowerCase() == 'artificial-lust') {
			...
			rgbheadlights.antialiasing = true;
	...
	function introOrCountdown():Void
	{
		if (SONG.song.toLowerCase() == 'inverted-ascension' && dad.curCharacter == 'cj') {
			...
			{
				dad.playAnim('intro', true);
				FlxG.sound.play(Paths.sound('woosh', 'CJ'), _variables.svolume/100);
					...
					if (PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection && camFollow.x != boyfriend.getMidpoint().x - 100)
						{
							...
							switch (curStage)
							{
								...
								case 'festival':
									camFollow.x = FlxMath.lerp(camFollow.x, boyfriend.getMidpoint().x - 202.33, (camLerp * _variables.cameraSpeed)/(_variables.fps/60));
									camFollow.y = FlxMath.lerp(camFollow.y, boyfriend.getMidpoint().y - 196.69, (camLerp * _variables.cameraSpeed)/(_variables.fps/60));
							}
								...
								default:
									switch (Math.abs(daNote.noteData))
									{
										case 0:
											...
											if (SONG.song.toLowerCase() == 'artificial-lust')
												dadRGB.playAnim('singLEFT' + altAnim, true);
										case 1:
											if (daNote.noteType == 1)
												...
												if (SONG.song.toLowerCase() == 'artificial-lust')
													dadRGB.playAnim('singDOWN' + altAnim, true);
											}
										case 2:
											if (daNote.noteType == 1)
												dad.playAnim('haha');
												...
												if (SONG.song.toLowerCase() == 'artificial-lust')
													dadRGB.playAnim('singUP' + altAnim, true);
											}
										case 3:
											dad.playAnim('singRIGHT' + altAnim, true);
											if (SONG.song.toLowerCase() == 'artificial-lust')
												dadRGB.playAnim('singRIGHT' + altAnim, true);
									}
							}
								...
								if (startedCountdown && daNote.mustPress)
								{
									...
									switch (daNote.noteData)
									{
										case 0:
											...
											if (SONG.song.toLowerCase() == 'artificial-lust')
												bfRGB.playAnim('singLEFTmiss', true);
										case 1:
											boyfriend.playAnim('singDOWNmiss', true);
											if (SONG.song.toLowerCase() == 'artificial-lust')
												bfRGB.playAnim('singDOWNmiss', true);
										case 2:
											boyfriend.playAnim('singUPmiss', true);
											if (SONG.song.toLowerCase() == 'artificial-lust')
												bfRGB.playAnim('singUPmiss', true);
										case 3:
											boyfriend.playAnim('singRIGHTmiss', true);
											if (SONG.song.toLowerCase() == 'artificial-lust')
												bfRGB.playAnim('singRIGHTmiss', true);
									}
				...
				hearts.forEach(function(heart:FlxSprite)
					{
						if (heart.ID > (lives - 1))
						{
							...
							if ((heart.y >= FlxG.height + heart.height && (_variables.scroll == "up")) || (heart.y <= 0 - heart.height && (_variables.scroll == "down")))
								heart.kill();
						}
					});
...
private function popUpScore(strumtime:Float):Void
	{
				...
				if (pixelShitPart2 == '')
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating + pixelShitPart2 + rgbString, 'shared'));
				else
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating + pixelShitPart2 + rgbString, 'week6'));
				rating.screenCenter();
...
private function keyShit():Void
		...
		if (!note.wasGoodHit)
		{
				...
				switch (note.noteData)
				{
					case 0:
						...
						if (SONG.song.toLowerCase() == 'artificial-lust')
							bfRGB.playAnim('singLEFT', true);
					case 1:
						boyfriend.playAnim('singDOWN', true);
						if (SONG.song.toLowerCase() == 'artificial-lust')
							bfRGB.playAnim('singDOWN', true);
					case 2:
						boyfriend.playAnim('singUP', true);
						if (SONG.song.toLowerCase() == 'artificial-lust')
							bfRGB.playAnim('singUP', true);
					case 3:
						boyfriend.playAnim('singRIGHT', true);
						if (SONG.song.toLowerCase() == 'artificial-lust')
							bfRGB.playAnim('singRIGHT', true);
				}
	...
	override function beatHit()
	{
		...
		if (SONG.song.toLowerCase() == 'artificial-lust') {
			if (!bfRGB.animation.curAnim.name.startsWith("sing")) {
				bfRGB.playAnim('idle');
			}
		}
		...
		if (SONG.song.toLowerCase() == 'artificial-lust')
		{
			if (!dadRGB.animation.curAnim.name.startsWith("sing"))
				dadRGB.dance();
		}
