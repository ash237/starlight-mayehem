...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('cj', [45, 46, 45], 0, false, isPlayer);
		animation.add('ruby', [47, 48, 47], 0, false, isPlayer);
		animation.add('duet', [49, 50, 49], 0, false, isPlayer);
		animation.add('max', [15, 16, 17], 0, false, isPlayer);
		animation.add('abel', [15, 16, 17], 0, false, isPlayer);
		animation.add('bfgf', [43, 44, 43], 0, false, isPlayer);
		animation.play(char);
		switch(char){
